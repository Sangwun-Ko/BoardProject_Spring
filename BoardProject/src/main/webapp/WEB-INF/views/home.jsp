...
<body>
		...
		<div class="banner">
			...
			<div class="planner_box">
				<div class="planner_contain">
					...
					<c:choose>
						<c:when test="${empty loginEmail}">
							<div class="planner_start_btn">
								<a href="#" onclick="login();">플래너 시작하기</a>
							</div>
						</c:when>
						<c:otherwise>
							<div class="planner_start_btn">
								<a href="Controller?command=planstart">플래너 시작하기</a>
							</div>
						</c:otherwise>
					</c:choose>
				</div>
	...
	<section class="section2">
		<div class="search_background">
			<img src="resources/images/homemar2022_dt_trans.png" alt=""> <a
				class="btn-open">
				<div class="search_box">
					<div class="search_contain">
						<label class="dodbogi_img" for="dodbogi"></label> <input
							id="dodbogi" type="text" placeholder="도시,국가,키워드로 검색"
							name="dodbogi" onkeyup="filter()">
					</div>
				</div>
				<div class="search_popup">
					<div class="geomsaegchang">
						<ul>
							<!-- 검색창 리스트 생성  -->
							<c:forEach var="list" items="${natList}">
								<li class="content_items"><a
									href="SearchSub.jsp?nat_id=${list.nat_id}">
										<div>
											<p class="name">
												<%-- <%=dto.getCityName() %> --%>
											</p>
